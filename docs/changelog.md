...
### v1.11
v1.11 加入了路線規畫系統，並把上個版本刪除的隨機與骰子指令加回來
- [1.11](https://github.com/d1fficult222/very_useful_bot/releases/tag/v1.11) (2026-06-09)
    - 新增：取得位置、查詢目標、規劃路徑
    - 新增：.env.example 參考文件

### v1.10
v1.10 翻新了 Wordle 的功能，精簡化 VeryUsefulBot 的功能，並提升穩定性。
...
### v1.9
v1.9 新增了過渡的課表系統，以及 notice_routine 指令
...
### v1.8
v1.8 使用了 Cogs 架構方便管理與開發指令，以及 Quotify 製作圖片引文功能
...
### v1.6
v1.6 加入了 Wordle 的統計數據，更新提醒系統並重新設計 OJ 系統
...
### v1.0
VeryUsefulBot 是個十分有用的 Discord Bot，可以記帳、計算簡易數學、隨機選取食物等
